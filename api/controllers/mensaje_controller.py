...
class MensajeController:
    ...
    def obtener_mensajes_por_canal(cls,canal_id):
        results = Mensaje.get_mensajes_by_canal(canal_id) #Llama al metodo get_mensajes_by_canal del Modelo Mensaje
    ...
    def borrar_mensaje(cls,id_mensaje,usuario_id):
        Mensaje.delete(id_mensaje, usuario_id) #Llama al metodo delete del modelo Mensaje
